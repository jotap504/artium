                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
                    ...
                    <div className="col-span-1 md:col-span-3">
                        ...
                        <div className="flex gap-4">
                            <a href="#" className="size-10 rounded-full border border-white/10 flex items-center justify-center text-white hover:bg-artium-gold hover:text-black hover:border-artium-gold transition-all duration-300">
